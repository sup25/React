...
import "./NavbarStyle.css"; // Importing a stylesheet for the navbar
    ...
    return (
      <>
        <nav>
          ...
          <div>
            <ul className={this.state.clicked ? /*check navabar is open or not*/"#navbar active" : "#navbar"} id="navbar">
              <li>
